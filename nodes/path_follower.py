...
class PathFollower(Node):
    ...
    def __init__(self):
        ...
        self.yaw_pub = self.create_publisher(
            Float64Stamped,
            'yaw_controller/setpoint',
            1
        )
        self.position_pub = self.create_publisher(
            PointStamped,
            'position_controller/setpoint',
            1
        )
    ...
    # ---------- on service call ----------
    # -------------------------------------
    def serve_set_path(self, request: SetPath.Request, response: SetPath.Response) -> SetPath.Response:
    ...
    def serve_path_finished(self, request: Trigger.Request, response: Trigger.Response) -> Trigger.Response:
        self.path = None
        response.success = True
